    ...
    function resolveRoute(path, action, context) {
      ...
      */
      ...
      processRoute(routeInfo, matchedRouteCtx, abortController.signal).then(function (val) {
        var forwardPath = val && val.forward;
        /*
        // Set the current data
        currentRouteData = {
          context: matchedRouteCtx,
        ...
        */
        ...
        if (forwardPath) {
          var ctx = _objectSpread(_objectSpread({}, matchedRouteCtx), val);
          ...
          resolve();
          emitter.emit("route", _objectSpread(_objectSpread(_objectSpread({}, matchedRouteCtx), val), {}, {
